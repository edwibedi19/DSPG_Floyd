...
*.prj - project file compatible with some GIS programs

See en.wikipedia.org/wiki/Shapefile for more information about ESRI shapefiles.
...
Besides the free GIS maps, software, tutorials and resources that you find at MapCruzin, we also locate data, create custom shapefile map layers and GIS projects to your specifications. Please contact me if you have a project in mind. 

Thank You

Mike Meuser
mike@mapcruzin.com (please use subject "GIS project question" in your email)